...
namespace Specs.Oaz.SpecFlowHelpers
{
	...
	public class TablesSteps
	{
		...
		public void ThenMyStuffValuesAreAsFollowing (Table table)
		{
			...
			Assert.That (Instance.Of<Stuff> ().Object, Is.EqualTo (table.As<Stuff> ()).Using (Properties.StrictComparison));
		}
		...
		{
			Assert.That (Instance.Of<IEnumerable<Stuff>> ().Object, Is.EqualTo (table.AsEnumerable<Stuff> ()).Using (Properties.StrictComparison));
		}
		...
		{
			Assert.That (Instance.Of<IEnumerable<Stuff>> ().Object, Is.Not.EqualTo (table.AsEnumerable<Stuff> ()).Using (Properties.StrictComparison));
		}
		...
		{
			Assert.That (Instance.Of<IEnumerable<Stuff>> ().Object, Is.Not.EquivalentTo (table.AsEnumerable<Stuff> ()).Using (Properties.StrictComparison));
		}

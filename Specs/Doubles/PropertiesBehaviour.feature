...
Scenario: group of inputs with properties not matching values
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of inputs in different orders with properties
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of inputs with subset of properties
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of inputs with subset of properties not matching values
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of inputs in different orders with subset of properties
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |

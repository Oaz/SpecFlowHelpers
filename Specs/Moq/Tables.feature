Feature: Tables
	...
	As a specflow user
	I want tables that quickly transform into mocks on interfaces
...
Scenario: Mock with properties not matching
	Given I have Stuff defined as following
	 | Field         | Value               |
	 | AString       | This is a string    |
	 | AnInt         | 234                 |
...
Scenario: Mock with properties matching on subset of properties
	Given I have Stuff defined as following
	 | Field         | Value               |
	 | AString       | This is a string    |
	 | AnInt         | 234                 |
...
Scenario: Mock with properties not matching on subset of properties
	Given I have Stuff defined as following
	 | Field         | Value               |
	 | AString       | This is a string    |
	 | AnInt         | 234                 |
...
Scenario: Mock with unknown property
	Given I have Stuff defined as following
	 | Field           | Value               |
	 | AWrongProperty  | Whatever            |
	When I do nothing
	Then I get an exception 'Unknown property AWrongProperty on type Specs.Oaz.SpecFlowHelpers.Moq.Stuff'
	
Scenario: group of mocks with properties
...
Scenario: group of mocks with properties not matching values
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of mocks in different orders with properties
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of mocks with subset of properties not matching values
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
...
Scenario: group of mocks in different orders with subset of properties
	Given I have lots of Stuff defined as following
	 | AString          | AnInt               | ADouble         | ADateTime               |
	 | This is a string | 234                 | 23.598          | 2010-07-17 22:34:48     |
	 | Yeah!            | 666                 | -21.65          | 2038-01-19 03:14:08     |
